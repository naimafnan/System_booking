                        ...
                        <div class="card" >
                            <div class="card-body">
                                <h4 class="text-center">
                                    ...
                                    <input type='date' id="datepicker3" class="form-control mb-2" name="dateText" placeholder="Select date"> 
                                @foreach ($appointments as $appointment )
                                    <input type="hidden" name="end_time" value="{{ $appointment->start_time }}"> 
                                @endforeach
                                @php
                    ...
                    <div class="col-lg-8 mb-2">
                        <div class="card" >
                            <div class="card-body">
                                ...
                                <div class="comment">
                                    <textarea type="number" style="width: 100%;min-height: 75px" id="remarks" name="reasons" placeholder="Remarks" required></textarea>
                                </div> 
                                <input type="hidden" id="provider_id" name="provider_id" value="{{ $provider_id }}"> 
                                <input type="hidden" id="providerDetails_id" name="providerDetails_id" value="{{ $providerDetails_id }}"> 
                                <input type="hidden" name="providerName" value="{{ $providers->myProvider->name }}"> 
